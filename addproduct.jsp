            ...
            <% Manufacturer manufacturer=(Manufacturer)session.getAttribute("manufacturer"); %>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col">
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#reg-modal">Delete
                                Product</button>
                        </div>
                        <div class="col">
                            <buttton class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#reg-modal">Edit
                                Product
                            </buttton>
                        </div>
                    </div>
                    <form action="addproduct.do" method="post">
                        ...
                        <% if(manufacturer !=null) {%>
                            <input type="hidden" name="manufacturer" value="<%= manufacturer.getManufacturerId()  %>">
                            <% } %>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Add Product
                                                </h5>
